...
namespace CoreCodeCamp.Controllers
{
    ...
    public class TalksController : ControllerBase
    {
        ...
        public async Task<ActionResult<TalkModel[]>> Get(string moniker)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, "Failed to get Talks:" + ex.Message);
            }
        }
        ...
        public async Task<ActionResult<TalkModel>> Get(string moniker, int id)
        {
            try
            {
                ...
                if (talk == null) return NotFound("The talk does not extist any more");
        ...
        public async Task<IActionResult> Delete(string moniker, int id)
        {
            try
            {
                ...
                if (talk == null) return NotFound("Foiled to find the talk to delete");
